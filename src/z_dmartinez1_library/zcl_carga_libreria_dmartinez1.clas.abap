CLASS zcl_carga_libreria_dmartinez1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CARGA_LIBRERIA_DMARTINEZ1 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_dm,
          ...
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_dm,
...
******** ZTB_CLNTS_LIB ********
    ...
    INSERT ztb_clnts_lib_dm FROM TABLE @lt_clnts_lib.
